...
x_raw = data_loader.load_predict_data()
...
with open ("/home/yunsoo/mysite-projects/soma/eval_prediction.pickle", 'wb') as f:
...
with open(out_path, 'w') as f:
    csv.writer(f).writerows(str(all_predictions))